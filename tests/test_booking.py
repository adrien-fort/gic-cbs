...
from src.booking import get_row_center, seat_sort_order, find_contiguous_blocks, block_center
from src.booking import seat_sort_order, build_seat_map, get_booked_seats, get_booking_id
from src.booking import confirm_reservation, _find_best_block_in_row
from src.booking import _find_first_row_with_block, default_seating_advanced
from src.booking import ordered_free_seat_map, book_ticket, default_seating, book_ticket_advanced
...
# Direct test for rightmost central seat in even row
def test_seat_sort_order_even_row_rightmost_central():
    seats = [f"A{i}" for i in range(1, 11)]
    # For 10 seats, central seats are A5 and A6, rightmost (A6) should come first
